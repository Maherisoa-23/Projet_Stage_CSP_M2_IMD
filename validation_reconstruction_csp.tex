...
benz\'eno\"ide~$\B$, sous les contraintes de conservation du carbone~(C1),
de blocs de z\'eros~(C2) et de voisinage admissible~(C3).
...
\begin{enumerate}[nosep]
  ...
  \item Tester la planarit\'e globale (ACP, seuil de 10\,degr\'es).
\end{enumerate}
