...
USAGE
=====
    python -m experiments.v3.main file.graph \\
...
def _parse_args():
    ...
    if args["config"]:
        ...
        from experiments.v3 import configs as _configs
        try:
...
def main():
    ...
    # __file__ = experiments/v3/main.py ; parents[2] = racine projet
    ...
    from experiments.v3.csp_model import build_and_solve_v3  # noqa: E402
    ...
    if args["do_validate"]:
        ...
        from experiments.v3.v3_pipeline import (
