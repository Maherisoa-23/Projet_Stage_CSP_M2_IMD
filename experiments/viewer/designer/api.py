...
def _project_root() -> Path:
    ...
    __file__ = experiments/viewer/designer/api.py -> 3 niveaux au-dessus.
    """
...
def _designer_output_root() -> Path:
    ...
    return _project_root() / "experiments" / "viewer" / "output" / "designer_jobs"
...
def api_run():
    ...
    rel_output = (Path("experiments/viewer/output/designer_jobs")
                  / job_id_tmp).as_posix()
