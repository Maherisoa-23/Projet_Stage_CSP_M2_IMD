...
Usage :
    python -m experiments.viewer.molviz.test_kekule_enum
ou directement :
...
from experiments.viewer.molviz.bonds import Atom, MolGraph
from experiments.viewer.molviz.kekule import enumerate_kekule
