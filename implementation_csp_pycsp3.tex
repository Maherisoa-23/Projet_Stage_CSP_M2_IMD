...
csp_solver/
  ...
  utils/
    ...
    validate.py              # xTB + planarite (single-run et multi-runs)
  reconstruction/
  ...
  experiments/
    ...
    update_report.py         # Generation du rapport global
...
python batch_main.py plane/benzdb/h4 --validate --n-runs 10
python batch_all.py  plane/benzdb/h4 --n-runs 10           # les 8 configs

# Generation des rapports HTML
python view.py output/h4 --aggregate                       # viewer h4
python update_report.py                                    # rapport global
