...
Usage :
    python -m viewer.analysis.compute --h h6
    python -m viewer.analysis.compute --h h6 --force
    python -m viewer.analysis.compute --h h6 --limit 100
