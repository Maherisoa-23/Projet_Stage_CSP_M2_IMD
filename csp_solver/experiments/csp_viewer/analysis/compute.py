...
Usage :
    python -m csp_solver.experiments.csp_viewer.analysis.compute --h h6
    python -m csp_solver.experiments.csp_viewer.analysis.compute --h h6 --force
    python -m csp_solver.experiments.csp_viewer.analysis.compute --h h6 --limit 100
