...
Pipeline :
  ...
  2. Copie le .graph
  3. python -m csp_solver.experiments_v2.main file.graph --config NAME
...
# Ajout au path :
#   - csp_solver/experiments/cluster/ pour atomic_io
#   - racine projet pour pouvoir importer csp_solver.experiments_v2.* en
...
# arborescence "csp_solver/experiments/_ev2_run/output/<h>/<config>/<mol>/solutions"
# pour rester coherent avec ce que le viewer attend.
LOGICAL_OUTPUT_ROOT = "csp_solver/experiments/_ev2_run/output"
...
def run_one_job_v2(graph_path: Path, config_name: str,
    ...
    try:
        ...
        #
        # Pour que `python -m csp_solver.experiments_v2.main` trouve le
        ...
        cmd = [
            sys.executable, "-m",
            "csp_solver.experiments_v2.main",
            str(graph_local),
            "--config", config_name,
            "--all",
            "--validate",
        ...
        from csp_solver.experiments_v2.db_helpers import (
