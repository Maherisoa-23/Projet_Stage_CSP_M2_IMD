...
USAGE
=====
    python -m csp_solver.experiments_v2.main file.graph \\
...
def _parse_args():
    ...
    if args["config"]:
        ...
        from csp_solver.experiments_v2 import configs as _configs
        try:
...
def main():
    ...
    from csp_solver.experiments_v2.csp_model import build_and_solve_v2  # noqa: E402
