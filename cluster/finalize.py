...
# Refactor option C : cluster/ est a la racine ; aggregate_md.py reste
# dans experiments/v1/ (specifique v1).
_HERE = Path(__file__).resolve().parent          # cluster/
_PROJECT_ROOT = _HERE.parent
AGGREGATE_MD = _PROJECT_ROOT / "experiments" / "v1" / "aggregate_md.py"
VIEW_PY = _PROJECT_ROOT / "experiments" / "v1" / "view.py"
